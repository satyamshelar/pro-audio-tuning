...
MenuBar {
    id: menuBar;
    property var fiberBasePanel
    property var captainInsight
    style: MenuBarStyle{
    ...
    Menu {
        ...
        MenuItem {
            text: qsTr("Captain Insight™")
            shortcut: "Ctrl+Shift+I"
            onTriggered: menuBar.captainInsight.open();
        }
        MenuItem {
    ...
    Menu {
        ...
        MenuItem {
            text: qsTr("FiberBase License")
            shortcut: "F4"
            onTriggered: menuBar.fiberBasePanel.open();
        }
        MenuItem {
            text: qsTr("About")
