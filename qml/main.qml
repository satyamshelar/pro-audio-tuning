...
ApplicationWindow {
    ...
    visible: true
    flags: Qt.Window
    title: "Sound Captain Tuning Lab Pro V7"
    ...
    onClosing: function (close) {
        ...
        dialog.title = qsTr("Close Sound Captain Tuning Lab Pro?")
    ...
    Menu.Top {
        id: topMenu;
        fiberBasePanel: licensePanel
        captainInsight: captainInsightPanel
    }
