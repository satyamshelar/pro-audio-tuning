...
int main(int argc, char *argv[])
{
    ...
    QCoreApplication::setApplicationName("SoundCaptainTuningLabPro");
    QCoreApplication::setApplicationVersion(APP_GIT_VERSION);
    QCoreApplication::setOrganizationName("Sound Captain Pro Audio");
    QCoreApplication::setOrganizationDomain("soundcaptain.pro");
